...
export class InitialMigration1732649684452 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bid" ("id" character varying(32) NOT NULL, "amount" integer NOT NULL, "auctionId" character varying(32), "bidderId" character varying(32), CONSTRAINT "PK_ed405dda320051aca2dcb1a50bb" PRIMARY KEY ("id"))`);
